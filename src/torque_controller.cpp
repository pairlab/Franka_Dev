...
TorqueController::TorqueController(double speed_factor, const std::array<double, 7> q_goal)
    : q_goal_(q_goal.data()) {
...
bool TorqueController::calculateDesiredValues(double t, Vector7d* delta_q_d) const {
...
void TorqueController::calculateSynchronizedValues() {
...
franka::JointPositions TorqueController::operator()(const franka::RobotState& robot_state,
